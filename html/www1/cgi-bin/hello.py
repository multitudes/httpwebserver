...
def main():
    ...
    message += "<ul>"
    message += f"<li>CONTENT_TYPE: {os.environ.get('CONTENT_TYPE', 'N/A')}</li>"
    message += f"<li>CONTENT_LENGTH: {os.environ.get('CONTENT_LENGTH', 'N/A')}</li>"
    ...
    message += f"<li>HTTP_UPLOAD_DIR: {os.environ.get('HTTP_UPLOAD_DIR', 'N/A')}</li>"
    message += f"<li>SERVER_PORT: {os.environ.get('SERVER_PORT', 'N/A')}</li>"
    message += "</ul>"
